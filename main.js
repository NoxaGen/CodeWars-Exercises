...
//1st year 1000 + 1000 * 0.02 + 50 => 1070 inhabitants
//2nd year 1070 + 1070 * 0.02 + 50 => 1141 inhabitants (** number of inhabitants is an integer **)
//3rd year 1141 + 1141 * 0.02 + 50 => 1213 (It will need 3 entire years.)
...
//nb_year(1500000, 2.5, 10000, 2000000) -> 10 Note: Don't forget to convert the percent parameter as a percentage
// in the body of your function: if the parameter percent is 2 you have to convert it to 0.02.

//p0 - population of beggining of the yeah
//percent - of increased population
//aug - number of inhabitants coming to live in town
//p - in this place i need to put number of citizens i want to target, they function need to calc in years and return int

function nbYear(p0, percent, aug, p) {
    let result = p0 * (percent / 100) + aug;
    let test = 0;
    let i = Math.round(p / result);
    console.log(result)
    ...
    console.log(Math.round(p / result));



    if (p > result) {
        console.log('need more then 1 year')
    } else {
        console.log('need less then one year')
    }
